...
/*                                                                            */
/*                                                                            */
/*    Provider_internal.hpp                          oooooo       oooooo      */
...
#ifndef LUMS_PROVIDER_INTERNAL_HPP
#define LUMS_PROVIDER_INTERNAL_HPP
...
namespace lm
{
    namespace internal
    {
         ...
         */
        template <typename T>
        class Provider : public BaseProvider<T>, public internal::Singleton<Provider<T>>
        {
         ...
         */
        template <typename T>
        class StreamProvider : public BaseProvider<T>, public internal::Singleton<StreamProvider<T>>
        {
        public:
    ...
    */
    using ShaderProvider = internal::Provider<ShaderProgram>;

    /**
    * A stream provider for images
    */
    using ImageProvider = internal::StreamProvider<Image>;

    /**
    * A stream provider for textures
    */
    using TextureProvider = internal::StreamProvider<Texture>;

    /**
    * A stream provider for fonts
    */
    using FontProvider = internal::StreamProvider<Font>;

    /**
    * A provider for game object templates
    */
    using GameObjectProvider = internal::Provider<GameObjectTemplate>;
}
